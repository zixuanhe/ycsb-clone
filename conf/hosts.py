...
env.roledefs = {
    ...
    'client': ['c1.citrusleaf.local', 'c2.citrusleaf.local', 'c3.citrusleaf.local', 'c4.citrusleaf.local', 'c5.citrusleaf.local', 'c6.citrusleaf.local', 'r3.citrusleaf.local', 'r5.citrusleaf.local'],
